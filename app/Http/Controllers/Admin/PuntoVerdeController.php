...
class PuntoVerdeController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.puntos-verdes.index', compact('puntosVerdes', 'municipalities'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $validated['municipality_id'] = $request->user()->id;
    ...
    {        
        // verificación manual:
        if ($puntoVerde->municipality_id !== $request->user()->id) {
            abort(403, 'No tienes permiso para editar este punto verde');
        }
    ...
    public function destroy(Request $request, PuntoVerde $puntoVerde)
    {
        if ($puntoVerde->municipality_id !== $request->user()->id) {
            abort(403, 'No tienes permiso para eliminar este punto verde');
        }
